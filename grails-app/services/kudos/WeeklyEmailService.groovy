...
class WeeklyEmailService {
    ...
    String buildEmailHtml(User recipient, List<Map> top3, int userKudos,
        ...
        // Comes from SERVER_URL in production; unset in development, in which
        // case the footer link is omitted rather than pointing nowhere.
        String siteUrl = grailsApplication.config.getProperty('grails.serverURL') ?: ''
...
<div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 500px; margin: 0 auto; background: #f9f9f9; border: 1px solid #ddd; border-radius: 8px; padding: 24px;">
    <h2 style="color: #333; margin-top: 0;">${appName} Weekly Report</h2>
