...
class WeeklyEmailService {
    ...
    void sendWeeklyEmails() {
        ...
        // Get week number for self-esteem message
        int weekNumber = (int)(System.currentTimeMillis() / (7L * 24 * 60 * 60 * 1000))
        int totalMessages = SelfEsteemMessage.count() ?: 1
        SelfEsteemMessage sem = SelfEsteemMessage.findBySortOrder(weekNumber % totalMessages)
